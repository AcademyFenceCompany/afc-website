document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateCartSession(itemNo, quantity) {
        fetch("/cart/update", {
            method: "POST",
            headers: {
            ...
            body: JSON.stringify({ item_no: itemNo, quantity: quantity }),
        })
    ...
    // Quantity Handlers (With AJAX Update)
    document
        ...
        .forEach((button) => {
            button.addEventListener("click", function () {
                ...
                const itemNo =
                    this.closest("tr").querySelector(".delete-btn").dataset
                        .item;
                ...
                updateCartTotal();
                updateCartSession(itemNo, newQuantity); // Update session via AJAX
            });
        });
