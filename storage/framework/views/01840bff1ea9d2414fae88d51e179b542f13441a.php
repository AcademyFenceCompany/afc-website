...
<div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="heightDropdown">
                        <li><a class="dropdown-item <?php echo e($height == '4ft' ? 'active' : ''); ?>" href="<?php echo e(route('chainlink.height', ['height' => '4ft'])); ?>">4ft Height</a></li>
                        <li><a class="dropdown-item <?php echo e($height == '5ft' ? 'active' : ''); ?>" href="<?php echo e(route('chainlink.height', ['height' => '5ft'])); ?>">5ft Height</a></li>
                        <li><a class="dropdown-item <?php echo e($height == '6ft' ? 'active' : ''); ?>" href="<?php echo e(route('chainlink.height', ['height' => '6ft'])); ?>">6ft Height</a></li>
                    </ul>
                </div>
                <h4 class="system-bundle-title text-center flex-grow-1"><?php echo e($height); ?> - Chain Link Fence Complete <?php echo e($systems[$system]['name']); ?></h4>
            </div>
        </div>
    </div>
    ...
    <div class="system-selection mb-2">
        ...
        <div class="row row-cols-1 row-cols-md-3 row-cols-lg-5 g-3">
            <!-- Regular systems (1-3) -->
            <?php $__currentLoopData = $systems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $systemId => $systemInfo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($systemId <= 3): ?>
                <div class="col">
                    <a href="<?php echo e(route('chainlink.height.system', ['height' => $height, 'system' => $systemId])); ?>" 
                       class="text-decoration-none">
                        <div class="system-card p-2 rounded <?php echo e($systemId == $system ? 'active' : ''); ?>">
                            <div class="system-image">
                                <img src="<?php echo e($systemInfo['image']); ?>" alt="<?php echo e($height); ?> Chain Link Fence">
                            </div>
                            <div class="bundle-info">
                                <h3 class="system-name h5"><?php echo e($systemInfo['name']); ?></h3>
                                <p class="system-description mb-0"><strong><span class="text-center">Frame:</span><br><span style="margin-left: 0"><?php echo e($systemInfo['frame']); ?></span></strong></p>
                                <p class="system-description mb-0"><strong><span class="text-center">Wire:</span><br><span style="margin-left: 0"><?php echo e($systemInfo['wire']); ?></span></strong></p>
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="<?php echo e(route('chainlink.height.system', ['height' => $height, 'system' => $systemId])); ?>" 
                       class="text-decoration-none">
                        <div class="system-card p-2 rounded <?php echo e($systemId == $system ? 'active' : ''); ?>">
                            ...
                            <div class="bundle-info">
                                <h3 class="system-name h5"><?php echo e($systemInfo['name']); ?> <img src="<?php echo e(url('storage/products/pcicon.jpg')); ?>" alt="Nonclimb" class="img-fluid" style="max-height: 20px; margin-right: 5px;"></h3>
                                <p class="system-description mb-0"><strong>Frame:<br><?php echo e($systemInfo['frame']); ?></strong></p>
                                <p class="system-description mb-0"><strong>Wire:<br><?php echo e($systemInfo['wire']); ?></strong></p>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <div class="system-info-box">
            <div class="row">
                ...
                <div class="col-12 col-md-6 text-center">
                    <img src="<?php echo e(url('storage/categories/chainlinkdraw.jpg')); ?>" alt="Chain Link Fence Diagram" class="img-fluid" style="max-height: 180px;">
                </div>
            </div>
        </div>
        ...
        <div class="system-bundle-content">
                ...
                <div class="installation-options mt-4">
                    ...
                    <div id="installation-content" class="collapse">
                        <ol class="installation-list">
                            ...
                            <li class="mt-2">
                                <strong>Install your <?php echo e($height); ?> chain link system yourself.</strong> In order to simplify the process of figuring out what fence parts you need for your fencing project and to calculate the actual price, we offer the following simple method:
                                
                                <ol class="installation-steps mt-2">
                                    <li>Select the Academy chain link fence system <?php echo e($height); ?> (five choices above)</li>
            ...
            <div class="bundle-products">
                <?php if(count($productGroups) > 0): ?>
                    <?php $__currentLoopData = $productGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoryKey => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="product-category">
                            <h3 class="product-category-title"><?php echo e($group['title']); ?> - <?php echo e($systems[$system]['name']); ?></h3>
                            
                            <?php if($categoryKey == 'terminal_posts'): ?>
                                ...
                                <?php $__currentLoopData = $group['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="product-item">
                                        <div class="product-item-header">
                                            <div class="product-item-title" style="margin-right: 8px"><?php echo e($product->product_name); ?>-<?php echo e($product->size); ?></div>
                                            <div class="product-item-actions">
                                                <div class="product-controls">
                                                    <div class="quantity-control quantity-small">
                                                        <div class="quantity-btn quantity-minus" onclick="updateQuantity(<?php echo e($product->id); ?>, -1)"><i class="bi bi-dash"></i></div>
                                                        <input type="number" id="quantity-<?php echo e($product->id); ?>" class="form-control quantity-input" value="1" min="1" onchange="updateTotalPrice(<?php echo e($product->id); ?>)">
                                                        <div class="quantity-btn quantity-plus" onclick="updateQuantity(<?php echo e($product->id); ?>, 1)"><i class="bi bi-plus"></i></div>
                                                    </div>
                                                    <div class="total-price" id="total-price-<?php echo e($product->id); ?>">$<?php echo e(number_format($product->price, 2)); ?></div>
                                                    <button class="btn btn-danger btn-sm cart-btn add-to-cart-btn ms-3" 
                                                            id="add-btn-<?php echo e($product->id); ?>"
                            ...
                            <?php else: ?>
                                ...
                                <?php $__currentLoopData = $productTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $baseName => $products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                
                                    <div class="product-item">
                                        <div class="product-item-header">
                                            <div class="product-item-title" style="margin-right: 8px"><?php echo e($baseName); ?></div>
                                            <div class="product-item-actions">
                                                <?php if(count($products) > 1): ?>
                                                    <div class="size-select">
                                                        <label for="size-select-<?php echo e($products[0]->id); ?>"></label>
                                                        <select class="form-select form-select-sm" id="size-select-<?php echo e($products[0]->id); ?>" 
                                                                onchange="updateProductPrice(this, <?php echo e(json_encode(array_map(function($p) { 
                                                                    return ['id' => $p->id, 'price' => $p->price, 'item_no' => $p->item_no]; 
                                                                }, $products))); ?>)">
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($product->id); ?>" data-item="<?php echo e($product->item_no); ?>" data-price="<?php echo e($product->price); ?>">
                                                                    <?php echo e($product->size ?? 'Standard'); ?>
                                                ...
                                                <div class="product-controls">
                                                    <div class="quantity-control quantity-small">
                                                        <div class="quantity-btn quantity-minus" onclick="updateQuantity(<?php echo e($products[0]->id); ?>, -1)"><i class="bi bi-dash"></i></div>
                                                        <input type="number" id="quantity-<?php echo e($products[0]->id); ?>" class="form-control quantity-input" value="1" min="1" onchange="updateTotalPrice(<?php echo e($products[0]->id); ?>)">
                                                        <div class="quantity-btn quantity-plus" onclick="updateQuantity(<?php echo e($products[0]->id); ?>, 1)"><i class="bi bi-plus"></i></div>
                                                    </div>
                                                    <div class="total-price" id="total-price-<?php echo e($products[0]->id); ?>">$<?php echo e(number_format($products[0]->price, 2)); ?></div>
                                                    <button class="btn btn-danger btn-sm cart-btn add-to-cart-btn ms-3" 
                                                            id="add-btn-<?php echo e($products[0]->id); ?>"
                                                            data-id="<?php echo e($products[0]->id); ?>"
                                                            data-item_no="<?php echo e($products[0]->item_no); ?>" 
                                                            data-product_name="<?php echo e($products[0]->product_name); ?>" 
                                                            data-price="<?php echo e($products[0]->price); ?>"
                                                            data-color="<?php echo e($products[0]->color ?? ''); ?>"
                                                            data-size="<?php echo e($products[0]->size ?? ''); ?>"
                                                            data-size_in="<?php echo e($products[0]->size_in ?? ''); ?>"
                                                            data-size_wt="<?php echo e($products[0]->size_wt ?? ''); ?>"
                                                            data-size_ht="<?php echo e($products[0]->size_ht ?? ''); ?>"
                                                            data-weight_lbs="<?php echo e($products[0]->weight_lbs ?? ''); ?>"
                                                            data-img_small="<?php echo e($products[0]->img_small ?? ''); ?>"
                                                            data-img_large="<?php echo e($products[0]->img_large ?? ''); ?>"
                                                            data-display_size_2="<?php echo e($products[0]->display_size_2 ?? ''); ?>"
                                                            data-size2="<?php echo e($products[0]->size2 ?? ''); ?>"
                                                            data-size3="<?php echo e($products[0]->size3 ?? ''); ?>"
                                                            data-material="<?php echo e($products[0]->material ?? ''); ?>"
                                                            data-spacing="<?php echo e($products[0]->spacing ?? ''); ?>"
                                                            data-coating="<?php echo e($products[0]->coating ?? ''); ?>"
                                                            data-style="<?php echo e($products[0]->style ?? ''); ?>"
                                                            data-speciality="<?php echo e($products[0]->speciality ?? ''); ?>"
                                                            data-free_shipping="<?php echo e($products[0]->free_shipping ?? '0'); ?>"
                                                            data-special_shipping="<?php echo e($products[0]->special_shipping ?? '0'); ?>"
                                                            data-amount_per_box="<?php echo e($products[0]->amount_per_box ?? '1'); ?>"
                                                            data-class="<?php echo e($products[0]->class ?? ''); ?>"
                                                            data-categories_id="<?php echo e($products[0]->categories_id ?? ''); ?>"
                                                            data-shipping_method="<?php echo e($products[0]->shipping_method ?? ''); ?>"
                                                            data-quantity="1"> Add to Cart
                                                    </button>
                                                </div>
                                            </div>
                ...
                <?php else: ?>
                    <div class="alert alert-warning">
                        <p>No products found for <?php echo e($height); ?> Chain Link Fence - <?php echo e($systems[$system]['description']); ?>.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afc-website\resources\views/categories/chainlink/height.blade.php ENDPATH**/ ?>