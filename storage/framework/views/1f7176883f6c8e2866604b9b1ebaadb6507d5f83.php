...
<footer class="footer mt-4 bg-dark text-light py-5 d-none d-md-block">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 mb-3">
                ...
                <ul class="list-unstyled">
                    ...
                    <li><a href="<?php echo e(route('about')); ?>" class="text-light">About us</a></li>
                    <li><a href="<?php echo e(route('contact')); ?>" class="text-light">Contact Us</a></li>
        ...
        <div class="d-flex align-items-center row">
            ...
            <div class="col-md-4 mt-4">
                <img src="<?php echo e(url('/resources/images/logo.png')); ?>" alt="Academy Fence Company Logo"
    ...
    <div class="container">
        ...
        <div class="footer__header">
            <div class="d-flex align-items-center justify-content-center gap-3 py-3 text-white flex-wrap">
                <!-- Logo -->
                <img src="<?php echo e(url('/resources/images/logo.png')); ?>" alt="Academy Fence Company Logo" class="footer-logo">
