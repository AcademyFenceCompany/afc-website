...
<?php $__env->startSection('title', $pageTitle ?? 'OnGuard Aluminum Fence Accessories'); ?>
...
<div class="container">
    <?php if(isset($accessoryGroups) && count($accessoryGroups) > 0): ?>
        <div class="row">
            ...
            <div class="col-md-3 accessory-sidebar">
                ...
                <div class="accessory-groups-list">
                    <?php $__currentLoopData = $accessoryGroups; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupName => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="accessory-group-item" data-group="<?php echo e($groupName); ?>">
                            <div class="accessory-group-title"><?php echo e($group['title']); ?></div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        const accessoryGroups = <?php echo json_encode($accessoryGroups ?? [], 15, 512) ?>;
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afc-website\resources\views/categories/aluminumfence-accessories.blade.php ENDPATH**/ ?>