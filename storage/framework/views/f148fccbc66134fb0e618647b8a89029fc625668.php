    ...
    <div class="row mb-4">
        ...
        <div class="col-md-3">
            ...
            <div class="product-image-container" id="product-image-container"> 
                <img src="<?php echo e($selectedProduct->img_large ? url('storage/products/' . $selectedProduct->img_large) : url('storage/products/default.jpg')); ?>" 
                     alt="<?php echo e($type); ?> <?php echo e($model); ?>" 
                     class="primary-image" 
                     id="primary-product-image"
                     onerror="this.src='<?php echo e(url('storage/products/default.jpg')); ?>'" 
                     onclick="openImageModal(this.src, this.alt)">
                <img src="<?php echo e($selectedProduct->img_small ? url('storage/products/' . $selectedProduct->img_small) : url('storage/products/default.jpg')); ?>" 
                     alt="<?php echo e($type); ?> <?php echo e($model); ?>" 
                     class="hover-image" 
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        (function($) {
            ...
            function updateProductImages(product) {
                ...
                // Default image path
                const defaultImage = '<?php echo e(url('storage/products/default.jpg')); ?>';
                
                // Set the primary image
                let primaryImageSrc = defaultImage;
                if (product.img_large) {
                    primaryImageSrc = '<?php echo e(url('storage/products/')); ?>/' + product.img_large;
                }
                
                // Set the hover image - use img_small if available, otherwise use the main image
                let hoverImageSrc = product.img_small ? 
                    '<?php echo e(url('storage/products/')); ?>/' + product.img_small : 
                    ...
                    response.associatedSections.forEach(function(section, index) {
                        ...
                        const firstProductImage = section.products.length > 0 ? 
                            (section.products[0].img_small ? 
                                ...
                                `<?php echo e(url('storage/products/default.jpg')); ?>`) : 
                            `<?php echo e(url('storage/products/default.jpg')); ?>`;
