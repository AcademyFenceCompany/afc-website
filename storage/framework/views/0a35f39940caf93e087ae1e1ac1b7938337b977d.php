...
<?php $__env->startSection('title', 'Aluminum Fence'); ?>
...
<?php $__env->startSection('content'); ?>
    <main class="container">
        ...
        <div class="row g-4 mb-4">
            ...
            <div class="col-md-6 wf-about">
                <div class="d-flex about-flex">
                    <img src="<?php echo e(url('storage/products/homepage2.jpg')); ?>" alt="Aluminum Fence" class="me-4 rounded about-image">
                    <div>
        ...
        <div class="row mb-5">
            ...
            <div class="col-md-8">
                <?php $__currentLoopData = $aluminum_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($category['family_category_id'] == 1055): ?>
                        <div class="card">
                            <div class="text-center p-2">
                                <?php if(isset($category['image'])): ?>
                                    <a href="<?php echo e(route('aluminumfence.index')); ?>" class="text-brown" style="text-decoration: none;"><img src="<?php echo e($category['image']); ?>" class="rounded" style="width: 100%; height: 300px; object-fit: cover;"></a>
                                <?php endif; ?>
                                <div class="text-center pt-2">
                                    <h4 class="card-title text-brown fw-bold"><a href="<?php echo e(route('aluminumfence.index')); ?>" class="text-brown" style="text-decoration: none;"><?php echo e($category['family_category_name']); ?></a></h4>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                            ...
                            <div class="col-6">
                                <div class="card h-100 border-0 shadow-sm">
                                    <div class="text-center p-2">
                                        ...
                                        <img src="<?php echo e($category['image']); ?>" class="rounded" style="width: 100%; height: 150px; object-fit: cover;">
                                        <?php endif; ?>
                                        <div class="text-center pt-2">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\afc-website\resources\views/categories/aluminumfence-main.blade.php ENDPATH**/ ?>