                        ...
                        for ($i = 0; $i < 6; $i++) {
                            ...
                            <div class="col-lg-4 col-sm-12 mb-4">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h5 class="card-title"><a href="/productdesc">Welded Wire</a></h5>
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                @foreach ($fenceCategories as $category)
                  <a href="index.html" class="nav-link category-item swiper-slide" style="border: 1px solid #868686;">
    ...
    <section class="py-5">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="banner-ad" style="background-color: #a8b2b3;background: url({{asset('assets/images/pngegg.pngd')}});background-repeat: no-repeat;background-position: right bottom; background-size: contain;color: #000;">
              <div class="banner-content p-5">
