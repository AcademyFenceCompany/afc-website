    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('.category-tree').addEventListener('click', function(e) {
                ...
                if (e.target.closest('.toggle-btn') || e.target.closest('.bi-chevron-right')) {
                    e.preventDefault();
                    e.stopPropagation();

                    const btn = e.target.closest('.toggle-btn') || e.target.closest('.bi-chevron-right')
                        .parentElement;
                    ...
                    if (nestedList) {
                        ...
                        if (icon) {
                            icon.style.transform = nestedList.classList.contains('show') ? 'rotate(90deg)' :
                                'rotate(0)';
                        }
                    }
                }
