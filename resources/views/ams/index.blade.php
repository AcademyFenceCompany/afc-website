...
<link rel="stylesheet" href="{{asset('css/admin-style-preset.css')}}" >
<style>
    .pc-sidebar .pc-link {
        font-size: 1rem;
    }
  ...
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="../dashboard/index.html" class="b-brand text-primary">
        ...
        <img src="{{asset('assets/images/thumbnail/thumbnail_20250603183845.png')}}" class="img-fluid logo-lg" alt="logo">
      </a>
    </div>
  ...
  <ul class="list-unstyled">
    ...
    <li class="pc-h-item d-none d-md-inline-flex">
      <form class="header-search">
        <i data-feather="search" class="icon-search bi bi-1-square"></i>
...
<!-- <script src="{{asset('js/plugins/custom-font.js')}}"></script>
<script src="{{asset('js/plugins/custom-ant-icon.js')}}"></script>
<script src="{{asset('js/plugins/pcoded.js')}}"></script>
