        ...
        @foreach ($specialityOrder as $specialityName)
            @if (isset($productsByspeciality[$specialityName]) && count($productsByspeciality[$specialityName]) > 0)
                <div class="col-md-4 mb-4">
                    <div class="speciality-header py-2">{{ $specialityName }}</div>
                    
                    @foreach($productsByspeciality[$specialityName] as $product)
                        @php
                        ...
                        <div class="product-card h-100">
                            ...
                            <div class="product-details small">  
                                @if (!empty($product->desc_short))
                                    ...
                                    @endphp
                                    <div class="mb-3 text-center">{!! $formattedDesc !!}</div>
                                @endif
