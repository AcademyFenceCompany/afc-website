                ...
                <div class="row">
                        ...
                        <div class="pricing-option-card h-100">
                            ...
                            <div class="pricing-option-body">
                                <div class="pricing-option-image">
                                    <img src="{{ url('storage/categories/chainlinkdraw.jpg') }}" alt="Complete Custom Chain Link Fence" onerror="this.src='{{ url('storage/products/default.png') }}'">
                                </div>
                                ...
                                <div class="pricing-option-actions">
                                    <a href="{{ route('chainlink.height', ['height' => '4ft']) }}" class="btn btn-danger">See Pricing Now</a>
                    ...
                    <div class="col-md-6">
                        <div class="pricing-option-card h-100">
                            ...
                            <div class="pricing-option-body">
                                <div class="pricing-option-image">
                                    <img src="{{ url('storage/categories/ch.webp') }}" alt="Complete Package Chain Link Fence" onerror="this.src='{{ url('storage/products/default.png') }}'">
                                </div>
                        ...
                        <div class="d-flex flex-wrap justify-content-between">
                            <div class="category-item d-flex align-items-center mb-3" style="width: 48%;">
                                <div class="pricing-option-image me-2" style="width: 40px;">
                                    <img src="{{ url('storage/categories/chainlink-wire.jpg') }}" alt="Chain Link Wire" onerror="this.src='{{ url('storage/products/default.png') }}'" style="max-height: 40px; max-width: 100%;">
                                </div>
                                <span>Wire</span>
                            </div>
                            <div class="category-item d-flex align-items-center mb-3" style="width: 48%;">
                                <div class="pricing-option-image me-2" style="width: 40px;">
                                    <img src="{{ url('storage/categories/chainlink-fittings.jpg') }}" alt="Chain Link Fittings" onerror="this.src='{{ url('storage/products/default.png') }}'" style="max-height: 40px; max-width: 100%;">
                                </div>
                                <span>Fittings</span>
                            </div>
                            <div class="category-item d-flex align-items-center mb-3" style="width: 48%;">
                                <div class="pricing-option-image me-2" style="width: 40px;">
                                    <img src="{{ url('storage/categories/chainlink-posts.jpg') }}" alt="Chain Link Posts" onerror="this.src='{{ url('storage/products/default.png') }}'" style="max-height: 40px; max-width: 100%;">
                                </div>
                                <span>Pipe/Posts</span>
                            </div>
                            <div class="category-item d-flex align-items-center mb-3" style="width: 48%;">
                                <div class="pricing-option-image me-2" style="width: 40px;">
                                    <img src="{{ url('storage/categories/chainlink-hardware.jpg') }}" alt="Chain Link Hardware" onerror="this.src='{{ url('storage/products/default.png') }}'" style="max-height: 40px; max-width: 100%;">
                                </div>
                                <span>Hardware</span>
                            </div>
                            <div class="category-item d-flex align-items-center mb-3" style="width: 48%;">
                                <div class="pricing-option-image me-2" style="width: 40px;">
                                    <img src="{{ url('storage/categories/chainlink-gates.jpg') }}" alt="Chain Link Gates" onerror="this.src='{{ url('storage/products/default.png') }}'" style="max-height: 40px; max-width: 100%;">
                                </div>
                                <span>Gates</span>
                            </div>
                        </div>
                        <div class="pricing-option-actions mt-auto">
                            <a href="{{ route('chainlink.height', ['height' => '4ft']) }}" class="btn btn-danger">View Individual Parts</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="group-grid">
                    <div class="group-card">
                        <a href="" class="text-decoration-none">
                            <div class="group-image">
                                <img src="{{ url('storage/categories/dog_run_complete.jpg') }}" alt="Dog Run Kennels">
                            </div>
                            <div class="group-info">
                    ...
                    <div class="group-card">
                        <a href="" class="text-decoration-none">
                            <div class="group-image">
                                <img src="{{ url('storage/categories/regualrpvtslats_sm2.jpg') }}" alt="Fence Slats">
                            </div>
                            <div class="group-info">
                    ...
                    <div class="group-card">
                        <a href="" class="text-decoration-none">
                            <div class="group-image">
                                <img src="{{ url('storage/categories/chainlinkdraw.jpg') }}" alt="Chain Link Fence">
                            </div>
                            <div class="group-info">
                    ...
                    <div class="group-card">
                        <a href="" class="text-decoration-none">
                            <div class="group-image">
                                <img src="{{ url('storage/categories/universal_pliers_sm.jpg') }}" alt="Fence Tools">
                            </div>
                            <div class="group-info">
