...
<main class="container">
    ...
    <div class="card">
        ...
        <div class="text-center mt-4 mb-4">
            <button onclick="window.location.href='{{ route('customerservice') }}'"
                class="btn {{ Route::is('customerservice') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">CUSTOMER
                SERVICE</button>
            <button onclick="window.location.href='{{ route('getquote') }}'"
                class="btn {{ Route::is('getquote') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">
                GET A QUOTE
            </button>
            <button onclick="window.location.href='{{ route('brochures') }}'"
                class="btn {{ Route::is('brochures') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">BROCHURES</button>
            ...
            <button onclick="window.location.href='{{ route('contact') }}'"
                class="btn {{ Route::is('contact') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">CONTACT
                US</button>
            ...
            <button onclick="window.location.href='{{ route('fenceinstallation') }}'"
                class="btn {{ Route::is('fenceinstallation') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">FENCE
                INSTALL</button>
            <button onclick="window.location.href='{{ route('privacypolicy') }}'"
                class="btn {{ Route::is('privacypolicy') ? 'btn-warning' : 'btn-outline-dark' }} mx-1">PRIVACY
                POLICY</button>
        </div>