        ...
        <div class="custom-container d-flex justify-content-between align-items-center flex-wrap">
            ...
            <div class="dropdown njfig-btn">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="https://www.academyfence.com/codes-and-permits/">Explore Now</a>
                    </li>
                    <li>
                        <a class="dropdown-item"
                            href="https://www.academyfence.com/codes-and-permits/photo-gallery/">View Photo Gallery</a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="https://www.academyfence.com/codes-and-permits/all-towns/">Find
                            your Town</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container-fluid bg-light-custom py-3">
        <div class="custom-container">
            ...
            <div class="container-fluid">
                ...
                <!-- Desktop Navigation -->
                <nav class="nav mb-3 d-none d-md-flex flex-nowrap overflow-auto">
                    <!-- Wood Fence Dropdown -->
                    <div class="dropdown">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=4%2Bin.%2Bx%2B4%2Bin.&amp;coating=Vinyl%20PVC">4" x 4"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=3%2Bin.%2Bx%2B3%2Bin.&amp;coating=Vinyl%20PVC">3" x 3"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=2%2Bin.%2Bx%2B4%2Bin.&amp;coating=Vinyl%20PVC">2" x 4"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=2%2Bin.%2Bx%2B2%2Bin.&amp;coating=Vinyl%20PVC">2" x 2"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=2%2Bin.%2Bx%2B2%2Bin.&amp;coating=Vinyl%20PVC">1 1/2" x 1 1/2"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%2B1%252F2%2Bin.%2Bx%2B4%2Bin.&amp;coating=Vinyl%20PVC">1 1/2" x 4"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=3%2Bin.%2Bx%2B2%2Bin.&amp;coating=Vinyl%20PVC">3" x 2"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%2Bin.%2Bx%2B3%2Bin.&amp;coating=Vinyl%20PVC">1" x 3"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%2Bin.%2Bx%2B2%2Bin.&amp;coating=Vinyl%20PVC">1" x 2"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%2Bin.%2Bx%2B1%2Bin.&amp;coating=Vinyl%20PVC">1" x 1"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%252F2%2Bin.%2Bx%2B1%2Bin.&amp;coating=Vinyl%20PVC">1/2" x 1"</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%252F2%2Bin.%2Bx%2B1%252F2%2Bin.&amp;coating=Vinyl%20PVC">1/2" Hardware Cloth</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%252F4%2Bin.%2Bx%2B1%252F4%2Bin.&amp;coating=Vinyl%20PVC">1/4" Hardware Cloth</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%252F8%2Bin.%2Bx%2B1%252F8%2Bin.&amp;coating=Vinyl%20PVC">1/8" Hardware Cloth</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=1%2Bin.%2Bx%2B1%2Bin.&coating=Vinyl%20PVC">1" Hex Netting/Chicken Wire</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=2%2Bin.%2Bx%2B2%2Bin.&coating=Vinyl%20PVC">2" Hex Netting/Chicken Wire</a></li>
                            <li><a class="dropdown-item" href="http://192.168.0.135/wwf-product?meshSize=4%2Bin.%2Bx%2B4%2Bin.&amp;coating=Galvanized">Knock-In Post</a></li>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @endforeach
                            <li>
                                <a class="dropdown-item" href="{{ route('post-caps') }}">Post Caps</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('temp-construction-fence') }}">Temp Construction Fence</a>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <div class="collapse mb-3" id="mobileNavMenu">
                    <div class="d-flex flex-column">
                        ...
                        <div class="dropdown mb-2">
                            <a href="{{ route('woodfence') }}" class="nav-link btn nav-btn dropdown-toggle"
                                data-bs-toggle="dropdown">WOOD FENCE</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('stockade.index') }}">Stockade Fence</a></li>
                                <li><a class="dropdown-item" href="{{ route('board-on-board') }}">Board Fence</a></li>
                                <li><a class="dropdown-item" href="{{ route('tongue-groove') }}">Tongue Groove Fence</a></li>
                        ...
                        <!-- Aluminum Fence Dropdown -->
                        <div class="dropdown mb-2">
                            <a href="{{ route('aluminumfence.main') }}" class="nav-link btn nav-btn dropdown-toggle"
                                data-bs-toggle="dropdown">ALUMINUM FENCE</a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('aluminumfence.index') }}">OnGuard Aluminum Fence</a></li>
                                <li><a class="dropdown-item" href="{{ route('aluminumfence.pickup') }}">Available for Pickup</a></li>
                            </ul>
