<section class="container py-5 d-none">
    ...
    <div class="row">
                        ...
                        <div class="col-6">
                            <ul class="list-unstyled">
                                <li class="align-items-center mb-2">
                                    <img src="https://www.academyfence.com/codes-and-permits/wp-content/uploads/2017/12/6-foot-board-on-board-and-4-foot-starling-aluminum-fence-Madison-NJ-Morris-County-3.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span style="width:100%">Welded Wire</span>
                                </li>
                                <li class="align-items-center mb-2">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ul class="list-unstyled">
                                <li class="align-items-center mb-2">
                                    <img src="https://www.academyfence.com/DIY/images/privacyslats/top-lock.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span style="width:100%">Privacy Slats</span>
                                </li>
                                <li class="align-items-center mb-2">
                                    <img src="https://fencesnj.com/storage/products/residential.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span>Aluminum Fence</span>
                                </li>
                                <li class="align-items-center mb-2">
                                    <img src="https://fencesnj.com/resources/images/Vinyl-coated-fence-category%201.png" alt="Fast" width="100%" class="rounded me-2">
                                    <span>Welded Wire</span>
                                </li>
                            </ul>
                        </div>
                        <div class="col-6">
                            <ul class="list-unstyled">
                                <li class="align-items-center mb-2">
                                    <img src="https://www.academyfence.com/images/wood/board_on_board_strait_on_top2_big.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span>Wood Fence</span>
                                </li>
                                <li class="align-items-center mb-2">
                                    <img src="https://www.academyfence.com/images/chainlink/4ft.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span>Chainlink Fence</span>
                                </li>
                                <li class="align-items-center mb-2">
                                    <img src="http://www.academyfence.com/images/pvc/privacy/chesterfield_lattice_100.jpg" alt="Fast" width="100%" class="rounded me-2">
                                    <span>Vinyl Fence</span>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="col-md-4 mb-4">
                ...
                <div class="bg-secondary rounded-5 h-100" style="background-color: rgb(158, 199, 206) !important;color: #000;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="section-header text-center">
                                <h6 class="section-title display-6 py-5">Get a<span class="text-primary"> instant quote</span> on your project.</h6>
                                </div>
                            ...
                            <div class="col-md-12 p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control form-control-lg" name="quote_details" id="quote_details" placeholder="Details of your project" rows="4"></textarea>
                                </div>
