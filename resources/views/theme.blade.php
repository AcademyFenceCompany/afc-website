...
<head>
  ...
  <body>
    <div class="navbar navbar-expand-lg fixed-top bg-primary" data-bs-theme="dark">
      <div class="container">
        <a href="../" class="navbar-brand">Dev Theme</a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown" data-bs-theme="light">
              ...
              <div class="dropdown-menu" aria-labelledby="download">
                ...
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="../5/pulse/bootstrap.rtl.css" download>bootstrap.rtl.css</a>
                <a class="dropdown-item" href="../5/pulse/bootstrap.rtl.min.css" download>bootstrap.rtl.min.css</a>
                <div class="dropdown-divider"></div>
